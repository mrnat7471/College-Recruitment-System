...
<?php if ($APPLICANT_READ == 1) { ?>
    ...
    <h6><b>Resident in the UK/EU for 3 years:</b> <?php if ($uk_eu_resident == 0) {
    echo 'No';
} else {
    echo 'Yes';
}?></h6>
    <h6><b>Criminal Conviction:</b> <?php if ($criminal_con == 0) {
    echo 'No';
} else {
    echo 'Yes';
}?></h6>
    ...
    <h6><b>Have you ever been fostered, adopted or placed in a children's home?</b> <?php if ($children_home == 0) {
    echo 'No';
} else {
    echo 'Yes';
}?></h6>
    <h6><b>Do you care for someone else's health or wellbeing needs?</b> <?php if ($wellbeing == 0) {
    echo 'No';
} else {
    echo 'Yes';
}?></h6>
    <h6><b>Interview Assistance Required?</b> <?php if ($interview_assist == 0) {
    echo 'No';
} else {
    echo 'Yes';
}?></h6>
