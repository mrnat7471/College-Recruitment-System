  ...
  <form>
    ...
    <div class="row">
      ...
      <div class="col">
        ...
        <label class="switch">
            <input type="checkbox" name="ADMIN_READ" value="true" <?php if ($ADMIN_READ == '1') {
    echo 'Checked';
}?>>
      ...
      <div class="col">
        ...
        <label class="switch">
            <input type="checkbox" name="APPLICANT_READ" value="true" <?php if ($APPLICANT_READ == '1') {
    echo 'Checked';
}?>>
            <span class="slider round"></span>
        </label>
    ...
    <div class="row">
      <div class="col">
        <h6>Role/manage</h6>
        <label class="switch">
            <input type="checkbox" name="ROLE_MANAGE" value="true" <?php if ($ROLE_MANAGE == '1') {
    echo 'Checked';
}?>>
            <span class="slider round"></span>
        </label>
      ...
      <div class="col">
        ...
        <label class="switch">
            <input type="checkbox" name="USER_ROLE_MANAGE" value="true" <?php if ($USER_ROLE_MANAGE == '1') {
    echo 'Checked';
}?>>
            <span class="slider round"></span>
        </label>
